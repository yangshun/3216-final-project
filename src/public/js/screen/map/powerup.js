...
var ShieldTile = function(x, y, r, c) {
  Tile.call(this);
  this.x = x * TILE_WIDTH;
  this.y = y * TILE_HEIGHT;
  this.tileX = x;
...
ShieldTile.prototype = new Powerup();
ShieldTile.prototype.constructor = ShieldTile;
ShieldTile.prototype.collide = function(anotherObject) {
  if (anotherObject instanceof Ninja) {
    this.dead = true;
    anotherObject.addFollower(new ShurikenShield(anotherObject));
  }
};
*/
